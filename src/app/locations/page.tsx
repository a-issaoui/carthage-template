              ...
              <Reveal as="li" key={location.slug} delay={(i % 4) * 0.07}>
                <Link href={`/locations/${location.slug}`} className="group block">
                  ...
                  <div className="mt-3.5 flex items-baseline gap-2.5">
                    <h2 className="font-display min-w-0 truncate text-lg font-medium leading-snug text-ink transition-colors duration-200 ease-out group-hover:text-copper-deep">
                      {location.name}
                    </h2>
